...
#background music
mixer.init()
mixer.music.load('lagu-naykilla.ogg')
mixer.music.play()
...
img_back = "purple-aesthetic.jpg"#game background
img_hero = "anya_player.png" #hero
img_enemy =  "apel-musuh.png" # enemy
...
background = transform.scale(image.load(img_back), (win_width, win_height))
      ...
      #create sprites
ship = Player(img_hero, 5, win_height - 100, 100, 150, 10)
